[Documentation](../README.md) / Temporary funding audit

# Temporary funding audit

- [Temporary registration-funding audit](#registration-funding-audit)

<a id="registration-funding-audit"></a>
...
or identify people. Funding groups affect rewards only when included in the
[signed bridge policy](bridge.md). Publishing this checker or producing a new
report alone does not change reward grouping.
...
<a id="registration-funding-audit--run-the-cached-watcher"></a>
...
<a id="registration-funding-audit--interpretation"></a>
