...
implicit share of this policy\textquotesingle s miner rewards.

\subsection{Deterministic quality}\label{42-deterministic-quality}

Reuse UMI\textquotesingle s exact text normalization and best-reference CER/WER implementation.
...
bootstrap\textquotesingle s hard sunset remains effective even if the successor is delayed.
