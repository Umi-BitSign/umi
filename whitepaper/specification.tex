...
The temporary
\href{../docs/BOOTSTRAP_WEIGHT_ADDENDUM.md}{\path|bootstrap_service_binary| addendum} is the
only exception to this section\textquotesingle s prohibition on a weight call while
\path|translation_weights_active| is false. It may authorize only the addendum\textquotesingle s exact
...
under a policy with \path|translation_weights_active: false|.
...
Because that addendum\textquotesingle s binary eligibility and equal expected service row are
...
\href{../docs/BOOTSTRAP_WEIGHT_ADDENDUM.md}{\path|bootstrap_service_binary| addendum}, which
...
defined in Section 10.3. The addendum\textquotesingle s service validator follows that addendum\textquotesingle s
